...
class JsonTreeNodeHandle {
    ...
    protected nodeChildren : string = "children"

    protected data : Object = {};

    constructor(nodeKey: string, nodeChildren = "children") {
     ...
     * @returns 
     */
    add(nodeValue: string, nodeObj:Object) {
        let data = this.data;
     ...
     * @returns 
     */
    _handleAdd(data:any, nodeValue:string, nodeObj:Object) {
     ...
     * @returns
     */
    _handleRemove(data:any, nodeValue: string) {
        /**
         * 1. 判断是否是个数组
         * 2. 数组则遍历循环，
         * 3. 删除符合条件的对象
     ...
     * @param {*} nodeObj 
     */
    update(nodeValue:string, nodeObj:any) {
        let data = this.data;
        this.data = this._handleUpdate(data, nodeValue, nodeObj)
        return this;
    }

    _handleUpdate(data:any, nodeValue:string, nodeObj:any) {
        /**
         * 1. 判断类型
         * 2. 
         */
